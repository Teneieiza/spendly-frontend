export function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path
        fill="#4CAF50"
        d="M24 44c5.2 0 10-2 13.6-5.2l-6.3-5.3C29.4 35.1 26.8 36 24 36c-5.3 0-9.8-3.4-11.4-8.1l-6.5 5C9.4 39.7 16.2 44 24 44z"
      />
      <path
        fill="#1976D2"
        d="M43.6 20.1H42V20H24v8h11.3c-.8 2.3-2.4 4.3-4.6 5.5l6.3 5.3C39.6 35.4 44 30.2 44 24c0-1.3-.1-2.7-.4-3.9z"
      />
    </svg>
  )
}
